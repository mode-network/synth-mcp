...
import {
  ...
  GetInsightsLiquidationRequest$zodSchema,
} from "../models/getinsightsliquidationop.js";
...
export function getInsightsLiquidation(
  client$: SynthCore,
  request?: GetInsightsLiquidationRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetInsightsLiquidationRequest$zodSchema.optional().parse(value$),
  ...
  const body$ = null;
  const path$ = pathToFunc("/insights/liquidation")();
  ...
  const context = {
    ...
    operationID: "get_/insights/liquidation",
    oAuth2Scopes: null,
