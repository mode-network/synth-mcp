...
import {
  ...
  GetInsightsPredictionPercentilesRequest$zodSchema,
} from "../models/getinsightspredictionpercentilesop.js";
 ...
 */
export function getInsightsPredictionPercentiles(
  client$: SynthCore,
  request?: GetInsightsPredictionPercentilesRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetInsightsPredictionPercentilesRequest$zodSchema.optional().parse(
        value$,
      ),
  ...
  const body$ = null;
  const path$ = pathToFunc("/insights/prediction-percentiles")();
  ...
  const context = {
    ...
    operationID: "get_/insights/prediction-percentiles",
    oAuth2Scopes: null,
